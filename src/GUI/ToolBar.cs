...
//			batch.DrawString(FontNormal, Level1.CountEnemies()+" Enemies Left", new Vector2(132, Height - 100), Color.White);
			...
			batch.Draw(SpritePowers, Vector2.UnitY*(Game1.Height-128), new Rectangle(0, 0, 128,128), new Color(30+90*(Convert.ToInt16(Level1.Player1.Power.Cost > Level1.Player1.Mana)),30,30,(int)(Level1.Player1.Power.Percentage*155+100)/2));
			batch.Draw(SpritePowers, Vector2.UnitY*(Game1.Height-128), new Rectangle(128*(Level1.Player1.Power.Index), 0, 128,128), Color.Multiply(new Color(1,1,1,1), (int)(Level1.Player1.Power.Percentage)*128+128));
		}
	}
}

...
namespace VirtusPecto.Desktop{
	public class ToolBar{
		...
		public void Draw(SpriteBatch batch) {
			...
			batch.Draw(Sprite2, new Vector2(164, 8), new Rectangle(0, 0, (int)(128*Level1.Player1.Mana/100),24), Color.DeepSkyBlue, 0, new Vector2(0, 0), new Vector2(1 , 1), SpriteEffects.None, 0);
			batch.DrawString(Font, Convert.ToString(Level1.Player1.Health) + "/100", new Vector2(32, 2), Color.White);
			batch.DrawString(Font, Convert.ToString(Level1.Player1.Mana) + "/100", new Vector2(196, 2), Color.White);
		}
	}
}

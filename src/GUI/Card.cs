	...
	public class Card{
		...
		public void Draw(SpriteBatch batch){
			...
			if(Level1.CreationManager?.CardNumber != number){
				...
				batch.Draw(Content.Sprite, new Vector2(Position2.X, Position2.Y), new Rectangle(2 * 128, 0, 128, 128), new Color(255,255,255, (int)cardColor.A), rot, new Vector2(64,160), 1, SpriteEffects.None, 0);

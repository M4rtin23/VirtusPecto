...
namespace VirtusPecto.Desktop{
	public class Power{
		public static Power Fireball = new Power(1, 1,(Vector2 self, Vector2 other, Entity[] entities) => {Level1.CreateFireball(entities != Level1.Enemy1, self, Motion.Angle(self, other));});
		...
		private static void punch(Vector2 self, Vector2 other, Entity[] entities){
		...
		private static void lightning(Vector2 self, Vector2 other, Entity[] entities){
